...
class contest_repository:
    ...
    def write_data_contest(obj: ContestDto) -> bool:
        ...
        command = instruction.format(obj.id_tipo_jogo, obj.nr_concurso, obj.dt_concurso, obj.vl_acumulado, obj.nr_proximo_concurso, obj.dt_proximo_concurso, obj.nr_ganhador)
